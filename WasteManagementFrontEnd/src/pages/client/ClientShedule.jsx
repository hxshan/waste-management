...
const ClientSchedule = () => {
  ...
  const handleAddSchedule = () => {
    const newEvent = {
      title: description,
      start: new Date(
        startDate.setHours(time.split(":")[0], time.split(":")[1])
      ),
      end: new Date(
        startDate.setHours(time.split(":")[0], time.split(":")[1]) + 3600000
      ), // 1 hour duration
    };
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col">
              ...
              <select
                value=""
                onChange={(e) => {}}
                className="border border-gray-300 rounded-md px-4 py-2 shadow-sm focus:ring focus:ring-blue-300 appearance-none bg-white"
              >
